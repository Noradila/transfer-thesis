...
%The network lifetime is defined by the percentage of surviving nodes above a threshold.
...
%is possible when the traffic is kept constant.
...
%Figure \ref{fig_tsch} shows the TSCH schedule and terminologies used. 
...
%TSCH translates the channelOffset into a frequency using this function:
