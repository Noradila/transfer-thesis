...
As the environment vary, it is not possible to replicate the same experiment as the topology might had changed depending on the RPL ETX value at each run. The nodes are possibly to take different routes to send the packet than in previous experiment.
